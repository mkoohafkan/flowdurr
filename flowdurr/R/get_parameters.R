get_parameters <-
structure(function#Parameter estimates for exceedance curve fitting.
...
...
### other parameters to pass to pel-functions. For more information, see 
### lmom::pelln3 and lmom::pelpe3.
){
