...
### a dataframe generated by get_waterdata().
  ...
  warning('Splitting by calendar year negates use of WYD.')
  ...
  return(yrtable)
### a dataframe with columns 'GMT' and wyXXXX, where XXXX is a year in the record.
}, ex = function(){
#  d = get_waterdata()
#  split_by_calendaryear(d)
})
